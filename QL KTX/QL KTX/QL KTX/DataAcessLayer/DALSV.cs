...
namespace QL_KTX.DataAcessLayer
{
    class DALSV: ISVDAL
    {
        ...
        public void themSV(SV sv)
        {
            ...
            fwrite.WriteLine();
            fwrite.Write(sv.Masv + "#" + sv.Maph + "#" + sv.Tensv + "#" + sv.Gioitinh + "#" + sv.Diachi + "#" + sv.Tenlop + "#" + sv.Sdt1);
            fwrite.Close();
        ...
        public void Update(List<SV> list)
        {
            ...
            for (int i = 0; i < list.Count; ++i)
                sw.WriteLine(list[i].Masv+ "#"+list[i].Maph + "#" + list[i].Tensv + "#" + list[i].Gioitinh + "#" + list[i].Diachi + "#" + list[i].Tenlop+"#"+list[i].Sdt1);
            sw.Close();
        }
    }
}
