...
namespace QL_KTX.Presentation
{
    public class FormMENU
    {
        ...
        public void menu1()
        {
            ...
            tt:
                ...
                switch (kt.Key)
                {
                    ...
                    case ConsoleKey.F2: Console.Clear(); thongke(); break;
        ...
        public void menu()
        {
            ...
            gd.pain("ESC", 9, 21); gd.pain("TRỞ LẠI", 60, 21);
        den:
            ConsoleKeyInfo kt = Console.ReadKey();
            switch (kt.Key)
            {
                ...
                case ConsoleKey.Escape: Console.Clear(); menu1(); break;
                default:
                    gd.pain("SAI THAO TÁC,ẤN LẠI THAO TÁC", 26, 29);
                    goto den;
            }
        }
        public void thongke()
        {
            gd.pain("KÍ TÚC XÁ TRƯỜNG ĐẠI HỌC SƯ PHẠM KĨ THUẬT HƯNG YÊN NĂM HỌC 2019-2020", 20, 9);
            gd.pain("╔══════════════════════════════════════════════════════════════════╗", 7, 10);
            gd.pain("╠═══════════════════════════════╦══════════════════════════════════╣", 7, 13);
            gd.pain("╠═══════════════════════════════╦══════════════════════════════════╣", 7, 16);
            gd.pain("╠═══════════════════════════════╦══════════════════════════════════╣", 7, 19);
            ...
            gd.pain("NỘI DUNG", 20, 12);
            gd.pain("THỐNG KÊ  PHÒNG KÍ TÚC", 42, 15);
            gd.pain("THỐNG KÊ SINH VIÊN", 42, 18);
            gd.pain("THỐNG KÊ  DOANH THU", 42, 21);
            gd.pain("TRỞ LẠI", 42, 24);
            gd.pain("F1", 12, 15);
            gd.pain("F2", 12, 18);
            gd.pain("F3", 12, 21);
            gd.pain("ESC",12, 24);
        den:
            ...
            switch (kt.Key)
            {
                case ConsoleKey.F1: Console.Clear(); fp.thongkephong(); break;
                case ConsoleKey.F2: Console.Clear(); fsv.menusv(); break;
                case ConsoleKey.F3: Console.Clear(); fh.menuhd(); break;
                case ConsoleKey.F4: Console.Clear(); thongke(); break;
                case ConsoleKey.Escape: Console.Clear(); menu1(); break;
                default:
                    gd.pain("SAI THAO TÁC,ẤN LẠI THAO TÁC", 26, 29);
                    goto den;
