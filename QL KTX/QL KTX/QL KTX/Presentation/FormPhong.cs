    ...
    class FormPhong
    {
        ...
        public void suaphong()
        {
            ...
            if (i < list.Count)
            {
                ...
                Console.WriteLine("bạn có muốn giữ lại mã phòng không(có ấn'C' không ấn 'K')");
                ConsoleKeyInfo k = Console.ReadKey();
                switch (k.Key)
                {
                    case ConsoleKey.C: break;
                    case ConsoleKey.K: Console.WriteLine("mời nhập mã phòng mới"); string mpm = Console.ReadLine(); p.Maph = mpm; break;
                }
        ...
        public void xoaphong()
        {
            ...
            if (i < list.Count)
            {
                Phongkt p = new Phongkt(list[i]);
                pbll.xoaphong(map);
                Console.WriteLine("ĐÃ XÓA PHÒNG");
            }
            else
            {
                Console.WriteLine("Không tồn tại mã phòng này");
        ...
        {
            Console.Clear();
            gd.pain("TỔNG SỐ PHÒNG KÍ TÚC", 9, 15);
            gd.pain("TỔNG SỐ SINH VIÊN", 9, 18);
            gd.pain("╔══════════════════════════════════════════════════════════════════╗", 7, 10);
            ...
            gd.pain("THỐNG KÊ PHÒNG NĂM HỌC 2019-2020", 10, 12);
            
             gd.ve(45, 15);tinhp();
            gd.ve(45, 18); tinhv();
          
            gd.pain(" ẤM ESC ĐỂ QUAY LẠI", 30, 40);
            Console.SetCursorPosition(40, 30);
        n:
            ConsoleKeyInfo kt = Console.ReadKey();
            ...
            switch (kt.Key)
            {
                ...
                case ConsoleKey.Escape: Console.Clear();FormMENU m = new FormMENU(); m.menu1(); break;
                default:
                    Console.WriteLine("sai thao tác!!! mời nhập lại"); Console.SetCursorPosition(40, 30);
                    goto n;
            }
