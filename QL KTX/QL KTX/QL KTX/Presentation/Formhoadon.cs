    ...
    class Formhoadon
    {
        ...
        public void them()
        {
            ...
            do
            {
                ...
                gd.ve(50, 12); hd.Maph = Console.ReadLine();
                List<Hoadon> hoad = hdbll.Lhoadon();
                for (int a = 0; a < hoad.Count; a++)
                {
                    if (hoad[a].Maph == hd.Maph) break;
                    {
                        gd.pain("ĐÃ CÓ MÃ PHÒNG MỜI KIỂM TRA LẠI", 30, 30);goto hd;
                    }
                }
            } while (string.IsNullOrEmpty(hd.Maph));
            {
        ...
        sw: gd.pain("", 50, 15);
            ...
            {
                Console.SetCursorPosition(20, 40); Console.WriteLine("sai thông tin mời nhập lại");
                goto sw;
            }
        sn: gd.pain("", 50, 18);
            try
        ...
        public void suahd()
        {
            ...
            if (i < list.Count)
            {
                ...
                if (tk >= 0) s.Tkhac = tk;
                s.Tt = s.Tienvesinh + s.Tkhac + tienphong() + tinhiendien() + tinhiennuoc();
                Console.WriteLine();
                hdbll.suahd(s);
            }
            else
        ...
        public void xoahd()
        {
            ...
            if (i < list.Count)
            {
                ...
                hdbll.xoahd(maph);
                Console.WriteLine("ĐÃ XÓA HÓA ĐƠN...");
            }
            else
            {
                Console.WriteLine("không tồn tại mã hóa đơn");
